...
const MyDisplay = () => {
  return (
    <div className="mx-auto md:px-5 grid w-full auto-rows-auto md:auto-rows-[19rem] grid-cols-6 gap-4 md:max-w-full my-20">
      <div className="col-span-6 md:col-span-3 lg:col-span-4 w-full min-h-[21rem] md:min-h-0 rounded-lg [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] relative overflow-hidden">
        <div>
          <Technology />
        </div>
      ...
      <div className="group col-span-6 md:col-span-6 lg:col-span-4 w-full min-h-[21rem] md:min-h-0 rounded-lg [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] relative overflow-hidden">
        ...
        >
          <iframe
            src="https://open.spotify.com/embed/playlist/6JM0XehGZlPfrFHefkLFcJ?utm_source=generator&theme=0"
            style={{
              top: 0,
              left: 0,
              width: "100%",
